...
- Name: ux-test.spec.js >> Game Flow — The Show >> Next Scenario button works at The Show
- Location: tests/ux-test.spec.js:179:5
    ...
    - generic [ref=e15]:
      - generic [ref=e16]:
        ...
        - generic [ref=e34]:
          ...
          - text: 1st
      - generic [ref=e39]: Your hitter squares to bunt. The pitcher delivers a sinker down -- the hitter pushes the bunt toward the first baseman. The bunt is decent -- about 20 feet in front of the plate toward first. The first basem
    - generic [ref=e44]:
      - generic [ref=e45]:
