...
- Name: ux-test.spec.js >> Game Flow — Majors >> can complete a scenario at Majors level
- Location: tests/ux-test.spec.js:151:5
    ...
    - generic [ref=e15]:
      - generic [ref=e16]:
        ...
        - generic [ref=e34]:
          ...
          - text: 2nd
      - generic [ref=e39]: You decide to relay the catcher's setup location to the batter. But how you do it matters. There's a big difference between relaying what you can SEE (the catcher's glove position) and using electronic devic
    - generic [ref=e44]:
      - generic [ref=e45]:
