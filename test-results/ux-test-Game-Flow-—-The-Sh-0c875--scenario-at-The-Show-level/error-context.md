...
- Name: ux-test.spec.js >> Game Flow — The Show >> can complete a scenario at The Show level
    ...
    - generic [ref=e15]:
      - generic [ref=e16]:
        ...
        - generic [ref=e34]:
          ...
          - text: Empty
      - generic [ref=e39]: You attack the zone on the first pitch to the leadoff hitter -- fastball, outer half, strike one! The hitter is now behind 0-1. Analytics show that after an 0-1 count, the average at-bat length drops from 4.
    - generic [ref=e44]:
      - generic [ref=e45]:
